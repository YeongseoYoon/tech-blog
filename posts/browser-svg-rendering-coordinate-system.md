...
summary: "에디터에서 SVG를 직접 다루게 되면서 공부한 SVG의 본질, 렌더링 파이프라인, viewBox 좌표계, transform, CTM까지의 기록"
tags: ["SVG"]
---
...
![말풍선 아이콘 결과](/static/images/05-chat-bubble.svg)
...
![타겟 마크 결과](/static/images/06-crosshair-target.svg)
...
![로딩 스피너 결과](/static/images/07-loading-spinner.svg)
